...
- [前端表单设计器组件（formCreate）](file://yudao-ui/yudao-ui-admin-vue3/src/plugins/formCreate/index.ts)
- [前端可视化编辑器组件（DiyEditor）](file://yudao-ui/yudao-ui-admin-vue3/src/components/DiyEditor/index.vue)
- [前端公共组件集合](file://yudao-ui/yudao-ui-admin-vue3/src/components/index.ts)
- [BPMN 流程设计器组件](file://yudao-ui/yudao-ui-admin-vue3/src/components/bpmnProcessDesigner/src/index.ts)
- [BPMN 扩展工具类（BpmnModelUtils）](file://yudao-module-bpm/src/main/java/cn/iocoder/yudao/module/bpm/framework/flowable/core/util/BpmnModelUtils.java)
</cite>

## 更新摘要
**所做更改**
- 移除了关于扩展组件和自定义组件扩展的相关内容
- 重新组织了模块扩展开发指南，聚焦核心扩展流程
- 更新了前端组件扩展相关内容，移除过时的扩展机制
- 简化了模块间通信机制的说明，突出实际可用的技术方案
