<template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <DealerForm ref="formRef" @success="getList" />
</template>
...
defineOptions({ name: 'OpshubDealer' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await DealerApi.getDealerPage(queryParams)
